...
- (void)initialize
{
    ...
    [button setImage:[[UIImage imageNamed:@"fs_icon_wave_2"] imageWithOverlayColor:self.waveColor]  forState:UIControlStateNormal];
    [button setBackgroundImage:[UIImage imageNamed:@"fs_chat_bubble"] forState:UIControlStateNormal];
...
- (void)setWaveColor:(UIColor *)waveColor
{
    if (![_waveColor isEqual:waveColor]) {
        ...
        [_contentButton setImage:[[UIImage imageNamed:@"fs_icon_wave_2"] imageWithOverlayColor:waveColor]  forState:UIControlStateNormal];
    }
}
...
- (void)startAnimating
{
    if (!_contentButton.imageView.isAnimating) {
        UIImage *image0 = [[UIImage imageNamed:@"fs_icon_wave_0"] imageWithOverlayColor:_animatingWaveColor];
        UIImage *image1 = [[UIImage imageNamed:@"fs_icon_wave_1"] imageWithOverlayColor:_animatingWaveColor];
