...
-(void)initItem
{
    self.imgGear1 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"gear_1"]];
    ...
    self.imgGear2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"gear_2"]];
    ...
    self.imgGear3 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"gear_3"]];
    ...
    [imgBgView setImage:[UIImage imageNamed:@"loading_background"]];
