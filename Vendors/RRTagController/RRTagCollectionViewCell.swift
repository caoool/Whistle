...
class RRTagCollectionViewCell: UICollectionViewCell {
    ...
    func initContent(tag: Tag) {
        ...
        issSelected = tag.issSelected
        textContent.backgroundColor = UIColor.clearColor()
        self.textContent.layer.backgroundColor = (self.issSelected == true) ? colorSelectedTag.CGColor : colorUnselectedTag.CGColor
        self.textContent.textColor = (self.issSelected == true) ? colorTextSelectedTag : colorTextUnSelectedTag
    }
