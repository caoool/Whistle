...
class NewFavorLocationView: UIViewController, MKMapViewDelegate, UISearchBarDelegate, CLLocationManagerDelegate {
    ...
    @IBAction func useCurrentLocationButtonTapped(sender: UIButton) {
        centerMapOnUser()
    }
    ...
    func mapView(mapView: MKMapView!, viewForAnnotation annotation: MKAnnotation!) -> MKAnnotationView! {
        ...
        anView.image = UIImage(named: "map_regular_pin.png")
